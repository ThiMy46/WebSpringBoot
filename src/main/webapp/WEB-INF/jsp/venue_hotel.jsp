...
<!--CENTER PAGE-->
    <tr valign="top">
		...
		<td>
            ...
            <link href="static/css/venue_hotel.css" rel="stylesheet" type="text/css" />
                    ...
                    <div style="margin-top: 10px;">
                        <div style="margin-left: 5px; margin-bottom: 10px;">
                            <div class="ct_tin_display">
                                ...
                                <strong style="color: #002060;">CONFERENCE VENUE:</strong><span style="font-weight: bold; font-size: 20px; color: #002060;"><br />
                                <span style="font-size: 20px;"></span><span style="font-size: 20px;"></span></span><span style="font-size: 16px;"><span style="font-size: 20px; color: #c00000;"><span style="font-size: 20px;"><span style="font-weight: bold; font-size: 20px;"><br />
                                ...
                                <br />
                                </span><span style="color: #002060;"><img alt="" src="static/Images/HCMUTE.jpg" style="width: 600px;" /></span><br />
                                <br />
                                <span style="font-weight: bold; color: #002060;"><br />
                                <br />
                                <span style="font-size: 20px;">WELCOME DINNER VENUE:</span></span><br />
                                <span style="color: #c00000;"><br />
                                <span style="font-size: 11pt;"><span style="font-weight: bold; font-size: 20px;">Kim Dung Restaurant</span><span style="font-weight: bold;">&nbsp;</span><br />
                                <span style="font-size: 20px;">No. 02, Dang Van Bi Street, Thu Duc District, Ho Chi Minh City<br />
                                <br />
                                <img alt="" src="static/Images/kim_dung_1.png" style="width: 600px;" /><br />
                                <br />
                                <img alt="" src="static/Images/kim_dung_2.png" style="width: 600px;" /><br />
                                </span></span></span><br />
                                <br />
                                <span style="font-size: 20px; text-align: left; font-weight: bold;"><span style="font-size: 20px; color: #002060;">GALA BANQUET DINNER VENUE:<br />
                                </span><br />
                                <span style="font-size: 20px; color: #c00000;">Sesan Restaurant&nbsp;</span><br />
                                </span><span style="font-size: 18px;"><span style="font-size: 20px; text-align: left;"><span style="font-size: 18px;"><span style="font-size: 20px; color: #c00000;">No. 14, Einstein Street, Thu Duc District,&nbsp;<span style="font-size: 20px; color: #c00000;">Ho Chi Minh City</span><br />
                                </span><a href="http://sesan.com.vn/" target="_blank"><span style="font-size: 20px;">http://sesan.com.vn/</span><br />
                                </a>
                                </span><br />
                                </span><span style="text-align: left; background-color: #ffc000; color: #002060;"><span style="font-size: 20px;"><strong>The best paper awards to be delivered at the Gala Banquet</strong></span><br />
                                </span></span><strong style="font-size: 20px;"><br />
                                </strong><img alt="" src="static/Images/Sesan_2.jpg" /><br />
                                <br />
                                <img alt="" src="static/Images/Sesan_1.jpg" style="width: 600px;" /><br />
                                <br />
                                <br />
                                <strong><span style="font-size: 20px; color: #002060;">HO CHI MINH CITY TOUR</span></strong><br />
                                <br />
                                <span style="font-size: 20px; color: #c00000;">Venue: </span><span style="font-size: 20px; color: #c00000;">Gather at Ho Chi Minh City Opera House&nbsp;</span><br />
                                <span style="font-size: 20px; color: #c00000;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; No.7, Cong Truong Lam Son Street, District 1, HCMC</span><span style="font-size: 20px;"><br />
                                </span>
                                <span style="color: #c00000;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span><span style="color: #002060;">&nbsp;</span><span style="background-color: #ffc000; text-align: left; font-size: 20px; color: #002060;">Departure: 08:00am&nbsp;<br />
                                <br />
                                <div style="text-align: center;"><img alt="" src="static/Images/Nha_hat_1.jpg" /></div>
                                </span><span style="color: #002060;"><br />
                                </span><img alt="" src="static/Images/nha_hat_3.jpg" /><br />
                                <br />
                                <strong style="color: #002060;">INFORMATION ABOUT HOTEL IN HO CHI MINH CITY</strong><br />
                                </span><span style="font-size: 18px; color: #002060;"><br />
                                <strong>
                                Please visit&nbsp;<span style="font-size: 18px;"><a href="https://www.tripadvisor.co.uk" target="_blank"><span style="font-size: 24px;">https://www.tripadvisor.co.uk</span></a><span style="font-family: &quot;times new roman&quot;;">&nbsp;</span></span>to find out all information about hotel in HCMC.</strong><br />
                                <br />
                                <br />
                                </span>
                                <br />
                                <div style="text-align: center;">
                                <div style="text-align: justify;"><span style="background-color: #ecedee; font-size: 12px; text-align: start;"><span style="font-size: 13px;">
                                <div style="text-align: center;">
                                <div style="text-align: justify;"><span style="font-size: 12px; text-align: start;"><br />
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    ...
                    <span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
                        <img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="../../Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=9a2b49b6-1786-43f2-bbbc-41e385cabf9b" style="height:50px;width:150px;border-width:0px;display:block;" />
