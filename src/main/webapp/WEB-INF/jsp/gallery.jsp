                ...
                <div class="bg_display">
                    <div class="display" style="float: left; width: 100%;">
                        <div class="title_display">
                             <a style='color:#666;' href=/?TopicId=b910c5e2-783f-48e9-997c-60b676f1cede>Gallery </a> 
                        </div>
                        <div style="margin-top: 10px;">
                            <div style="margin-left: 5px; margin-bottom: 10px;">
                                <div class="ct_tin_display">
                                    <div class="articleTitle">
                                        <a href="/?ArticleId=1b72fbf0-b88a-42b1-86cd-a213a7496e10">icsse2017 photos gallery</a>
                                    </div>
                                    ...
                                    <div class="articleContent">
                                        ...
                                        <br />
                                        <div style="text-align: center;"><span style="font-size: 24px; color: #002060; text-align: left;"><span style="font-size: 28px;">Click below button to download ICSSE2017 photos:</span><br />
                                        <br />
                                        </span></div>
                                        </span>
                                        <div style="text-align: center;">
                                            <div style="text-align: center;"><a href="https://drive.google.com/open?id=0B6bYirEMSoOScWdncUEtYk51RDQ" target="_blank" style="text-align: left;"><img alt="" src="static/Images/download.jpg" style="width: 300px;" /></a></div>
                                            <br />
                                            <br />
                                        </div>
                                    </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    ...
                    <span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
                        <img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="../../Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=e895e126-3f50-4578-b8a9-0590b5c5c96d" style="height:50px;width:150px;border-width:0px;display:block;" />
